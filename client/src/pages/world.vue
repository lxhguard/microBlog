        ...
        <div class="Pcontainer">
            <ul>
                <li v-for="(posting,listindex) in list" :key="listindex" class="feed">
                    ...
                    <!-- 头像框 -->
                    <div class="avatar" >
                        <router-link class="nick" 
                            :to="{name:'Kongjian',params:{name:posting.info.username}}"
                        >
                    ...
                    <div class="box bgr" >
                        ...
                        <div class="ft" >
                            ...
                            <div class="op">
                                ...
                                <!-- 评论 -->
                                <a  @click="showCommentInput(listindex)">评论({{posting.cnumber}})</a>
                                <!-- 转发 -->
                                <a href="#">转发</a>
                            </div>
                        </div>
                        ...
                        <div class="box_extra bor" >
                            ...
                            <div class="mod_comment">
                                ...
                                <br>
                                <!-- 评论框 -->
                                <div v-if="commentInput[`${listindex}`]">
                                    <!-- 发表评论 -->
