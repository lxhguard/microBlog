                    ...
                    <div class="box bgr" >
                        ...
                        <div class="ft" >
                            ...
                            <div class="op">
                                ...
                                <a href="#">转发</a>
                                <!-- 更多操作 -->
                                <div class="dropdown" @mouseover="WillShowMenu(index)" @mouseout="NotShowMenu(index)" >
                                    <a href="javascript:void(0);">
                                        更多
                                    </a>
                                    <div class="dropdown-menu" v-if="showMenu[`${index}`]" >
                                        <ul>
                                            <li><router-link :to="{name:'BianJi',params:{id:posting._id}}">编辑</router-link></li>
...
export default {
    ...
    methods:{
        ...
        WillShowMenu(index){//更多操作 显示
            this.$set(this.showMenu,index,true);
            clearInterval(this.timer)
        },
        NotShowMenu(index){//更多操作 关闭
            this.timer = setInterval( () => {　
                this.$set(this.showMenu,index,false);
    　　　　　　}, 100);
        },
          ...
          this.$axios({
              ...
              .then(res=>{
                  ...
                  if(res.data.status == 200){
                      ...
                      console.log(this.showMenu.length)
